...
import com.spring.agendalive.payload.request.LoginRequest;
import com.spring.agendalive.payload.request.SignupRequest;
import com.spring.agendalive.payload.response.JwtResponse;
import com.spring.agendalive.payload.response.MessageResponse;
...
public class AuthController {
    ...
    @PostMapping("/roles")
    public ResponseEntity<?> savePost(@Valid @RequestBody Role role) {
    ...
    @GetMapping("/roles")
    public ResponseEntity<List<Role>> getPosts() {
